                            ...
                            <div class="row">
                                 ...
                                 <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        @endif
                                            <form id="user" class="user" method="POST" action="{{ url('simpaneditjeniscuti',$datas->id_cuti) }}" >
                                                @csrf
                                            <div class="form-group">
                                                <i class="fas fa-journal-whills"></i>
                                                <span>Jenis Cuti</span>
                                                    <input id="jenis_cuti" type="text" class="form-control form-control-user @error('jenis_cuti') is-invalid @enderror" name="jenis_cuti" value="{{$datas->jenis}}" required autofocus placeholder="Jenis Cuti">
                                                    @error('jenis_cuti')
                                             ...
                                             <div class="form-group">
                                                ...
                                                <span>Jumlah Maksimal Cuti</span>
                                                    <input id="max_cuti" type="number" class="form-control form-control-user @error('max_cuti') is-invalid @enderror" name="max_cuti" value="{{ $datas->jumlah_hari }}" required autofocus placeholder="Maksimal Cuti">
                                                    @error('max_cuti')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="P"{{$datas->jk=="P"? 'selected':''}}>Perempuan </option>
                                            <option value="L"{{$datas->jk=="L"? 'selected':''}}>Laki-Laki</option>
                                            <option value="all"{{$datas->jk=="all"? 'selected':''}}>Umum</option>
                                        </select>
                                        </div>
                                        @error('jk')
                                        <span class="invalid-feedback" role="alert">
                                        ...
                                        @enderror 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option disabled  selected value="0">Pilih Salah Satu...</option>
                                                <option value="0"{{$datas->file=="0"? 'selected':''}}>Tidak Dibutuhkan </option>
                                                <option value="1"{{$datas->file=="1"? 'selected':''}}>Dibutuhkan</option>
                                            </select>
                                            </div>
                                            @error('file')
                                            <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option disabled  selected value="0">Pilih Salah Satu...</option>
                                                <option value="0"{{$datas->kategori=="0"? 'selected':''}}>Umum </option>
                                                <option value="1"{{$datas->kategori=="1"? 'selected':''}}>Khusus Yayasan</option>
                                            </select>
                                            </div>
                                            @error('kategori')
                                            <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option disabled  selected value="0">Pilih Salah Satu...</option>
                                                <option value="KTY"{{$datas->kategori_karyawan=="KTY"? 'selected':''}}>Karyawan Tetap </option>
                                                <option value="KTTY"{{$datas->kategori_karyawan=="KTTY"? 'selected':''}}>Karyawan Tidak Tetap</option>
                                            </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option disabled  selected value="0">Pilih Salah Satu...</option>
                                                <option value="0"{{$datas->sesi=="0"? 'selected':''}}>Fleksibel </option>
                                                <option value="1"{{$datas->sesi=="1"? 'selected':''}}>Tahunan</option>
                                            </select>
                                            </div>
                                            @error('sesi')
                                            <span class="invalid-feedback" role="alert">
