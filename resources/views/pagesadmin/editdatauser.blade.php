                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form id="profile" class="user" method="POST" action="{{ url('editdatauser',$datauser->id) }}">
                                        ...
                                        <div class="form-group row ">
                                            <i class="far fa-building"></i>
                                            <span>Mengajar lebih dari 1 Divisi</span>
                                            <select class="form-control   @error('multidivisi') is-invalid @enderror " name="multidivisi" id="multidivisi" required>
                                                <option value="N" @if ($datauser->multidivisi === 'N') selected @endif>Tidak</option>
                                                <option value="Y" @if ($datauser->multidivisi === 'Y') selected @endif>Ya</option>
                                            </select>
                                            @error('multidivisi')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
