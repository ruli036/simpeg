                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Form Tambah Kehadiran Absensi!</h1>
                                        </div>
                                        ...
                                        @endif
                                            <form id="surat" name="slip"  class="user" method="POST" action="{{url('add-data-absensi')}}" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input id="tgl" type="datetime-local" value="{{old('tgl')}}"  class=" form-control form-control-user @error('tgl') is-invalid @enderror" name="tgl"    placeholder="Nama"  >
                                                        @error('tgl')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
