                ...
                <div class="container">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-5 d-none d-lg-block"><img style="padding-top: 20px" src="{{asset('img/logo.png')}}" width="90%"> </div>
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        ...
                                        @endif
                                          ...
                                          @endif
                                          <form id="login" action="{{url('/gantipass')}}" method="POST">
                                              @csrf
                                              <label for="inputPassword5" class="form-label">Password Lama</label>
                                                <input type="password" name="passwordlama" id="inputPassword5" class="form-control"   required>
                                                @error('passwordlama')
